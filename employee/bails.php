            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Bails Available</h6>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div>
                                                <img src="assets/img/small-logos/devto.svg" class="avatar avatar-sm rounded-circle me-2" alt="devto">
                                            </div>
                                            <div class="my-auto">
